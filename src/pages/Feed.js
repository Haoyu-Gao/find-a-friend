...
import {authFunctions, auth_functions, profileFunctions, profile_functions} from "../firebase";
...
class UploadDialog extends React.Component {
    ...
    render() {
        return(
            <Dialog open = {this.props.open} onClose = {this.props.onClose} aria-labelledby = "simple-diaglog-title" fullWidth scroll = "paper">
        ...
        return (
            <div>
                ...
                <Box style = {outerContainer}>
                    ...
                    <UploadDialog opne = {this.state.posting} onClose = {this.closePostModal}/>
                </Box>
            </div>
        )
    }
